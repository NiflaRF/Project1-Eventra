...
const FacultyDashboard: React.FC = () => {
  ...
  const notifications = [
    {
      ...
      message: 'Your Tech Conference 2024 booking has been approved',
      time: '2 hours ago',
      type: 'success'
    },
    {
      ...
      message: 'Please submit additional documents for Cultural Event',
      time: '1 day ago',
      type: 'warning'
    },
    {
      ...
      message: 'New venue "Innovation Hub" is now available for booking',
      time: '2 days ago',
      type: 'info'
    }
  ];
  ...
  const getNotificationColor = (type: string) => {
    // All notifications use transparent background and border only
    return 'border-gray-200 bg-transparent';
  };

  return (
    <Layout>
      {/* Dashboard Background with Overlay - full screen style */}
      <div className="relative min-h-screen w-full flex flex-col justify-center items-stretch">
        <div style={{
          position: 'absolute',
          top: 0,
          left: 0,
