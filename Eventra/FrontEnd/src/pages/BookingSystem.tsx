...
const BookingSystem: React.FC = () => {
  ...
  const availableVenues = [
    { id: '1', name: 'Main Auditorium', capacity: 500, available: true },
    { id: '2', name: 'Conference Hall', capacity: 100, available: false },
    { id: '3', name: 'Open Ground', capacity: 1000, available: true },
    { id: '4', name: 'Innovation Hub', capacity: 150, available: true }
  ];
  ...
  return (
    <Layout>
      <div className="space-y-8 animate-fade-in w-full flex justify-center min-h-screen" style={{ backgroundImage: "url('/Contact Us.jpg')", backgroundSize: 'cover', backgroundPosition: 'center' }}>
        <div className="w-full max-w-5xl mx-auto px-4 md:px-8">
          ...
          <div className="bg-black bg-opacity-60 rounded-xl p-6">
            <h2 className="text-xl font-bold text-white mb-4">Search Available Venues</h2>
            <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
              ...
              <div>
                <label className="block text-sm font-medium text-white mb-2">Min. Capacity</label>
                <input
                  type="number"
                  value={minCapacity}
              ...
              <div className="flex items-end">
                <button
                  ...
                  className="w-full flex items-center justify-center bg-gray-800/80 hover:bg-gray-900 text-white px-4 py-2 rounded-lg font-medium transition-colors"
                >
