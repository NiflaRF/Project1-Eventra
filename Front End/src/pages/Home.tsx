...
const Home = () => {
  ...
  return (
    <div className="min-h-screen w-full flex flex-col bg-gray-50" style={{ width: '100vw', margin: 0, padding: 0 }}>
      ...
      <header className="bg-black shadow-md sticky top-0 z-20">
      ...
      <section
        style={{
          backgroundColor: '#4A0404', // Changed to Ox blood color
          width: '100%',
          minHeight: '350px',
        }}
      ...
      <section
        ...
        style={{
          backgroundImage: "url('/Galena.jpg')",
      ...
      >
        ...
        <div className="relative z-10 flex flex-col items-center justify-center">
          <p className="text-lg font-medium mb-2 text-white">Need help? We’re here for you.</p>
      ...
      <footer
        ...
        style={{ backgroundColor: '#4A0404' }} // Changed to Ox blood color
      >
