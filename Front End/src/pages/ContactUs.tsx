...
const ContactUs = () => {
  ...
  return (
    <div className="min-h-screen w-screen flex flex-col items-stretch bg-gray-50 relative" style={{ width: '100vw', margin: 0, padding: 0 }}>
      {/* Background image */}
      <div className="absolute inset-0 z-0" style={{ backgroundImage: "url('/Contact Us.jpg')", backgroundSize: 'cover', backgroundPosition: 'center' }} />
      {/* Dark overlay */}
