...
const EventPlanning: React.FC = () => {
  ...
  const eventTypes = ['Conference', 'Workshop', 'Cultural', 'Sports', 'Academic', 'Social', 'Exhibition'];
  const availableFacilities = [
    'Projector', 'Microphone', 'Speaker System', 'Stage Setup', 
    'Lighting System', 'Recording Equipment', 'Wi-Fi', 'Air Conditioning',
    'Whiteboard', 'Flip Chart', 'Catering Services', 'Security'
  ];
  ...
  return (
    <Layout>
      <div style={{ backgroundImage: "url('/Spd.jpg')", backgroundSize: 'cover', backgroundPosition: 'center', minHeight: '100vh', width: '100%' }}>
