...
const AdminDashboard: React.FC = () => {
  ...
  const adminActions = [
    ...
    {
      title: 'Manage Venues',
      description: 'CRUD operations for venue management',
      icon: MapPin,
      link: '/venues',
      color: 'bg-green-500'
    },
    ...
    },
    {
      ...
      description: 'Review submitted event plans',
      icon: FileText,
      link: '/admin/tools?tab=approvals',
      color: 'bg-purple-500'
    },
  ...
  const recentActivities = [
    {
      ...
      user: 'Jane Smith',
      details: 'Tech Conference 2024 - Main Auditorium',
      time: '10 minutes ago',
      type: 'approval'
    },
    {
      ...
      user: 'John Doe',
      details: 'Student role - Computer Science Department',
      time: '1 hour ago',
      type: 'registration'
    },
    {
      ...
      user: 'Admin',
      details: 'Innovation Hub - Capacity increased to 150',
      time: '2 hours ago',
      type: 'update'
    },
    {
      ...
      user: 'Prof. Wilson',
      details: 'Annual Science Fair - Multiple venues required',
      time: '3 hours ago',
      type: 'submission'
    }
  ];
                ...
                {overviewCards.map((card, index) => (
                  ...
                  >
                    <div className="flex items-center justify-between mb-4">
                      <div className={`${card.color} bg-opacity-80 p-3 rounded-xl text-white group-hover:scale-110 transition-transform duration-200 shadow-lg`}>
                        <card.icon size={24} />
                      </div>
