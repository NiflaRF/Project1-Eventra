...
const DUMMY_REQUESTS = [
  {
    ...
    requestedBy: { name: 'Jane Doe', email: 'jane@university.edu' },
    venue: 'Main Auditorium',
    dateTime: '2025-07-10T18:00',
  ...
  },
  {
    ...
    requestedBy: { name: 'John Smith', email: 'john@university.edu' },
    venue: 'Seminar Hall 2',
    dateTime: '2025-07-12T14:00',
  ...
  },
  {
    ...
    requestedBy: { name: 'Alice Lee', email: 'alice@university.edu' },
    venue: 'Sports Ground',
  ...
  // Extra dummy request for Sound System
  {
    ...
    requestedBy: { name: 'Rahul Verma', email: 'rahul@university.edu' },
  ...
  {
    id: 5,
    eventName: 'Convocation Ceremony',
    requestedBy: { name: 'Priya Patel', email: 'priya@university.edu' },
    venue: 'Main Auditorium',
...
const DUMMY_NOTIFICATIONS = [
  ...
  { id: 3, message: '🔔 Request "Sports Meet" approved.', time: '10 min ago' },
];
